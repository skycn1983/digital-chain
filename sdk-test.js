...
async function testSDK() {
  ...
  try {
    ...
    // Subscribe to events briefly
    const chainUpdatePromise = new Promise((resolve) => {
    ...
    // Set timeout
    setTimeout(() => {
      if (!chainUpdatePromise) {
        console.log('  ⏱️  No chain_update received within 5s (OK if no new blocks)');
      }
    }, 5000);
